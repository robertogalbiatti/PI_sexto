<?php 
    ...
    $sql = "INSERT INTO fornecedores (id_fornecedores, razao_social, email, cnpj, endereco, num, bairro, cep, telefone) VALUES 
    (null, '$razao_social','$email','$cnpj','$endereco', '$num', '$bairro', '$cep', '$telefone')";
