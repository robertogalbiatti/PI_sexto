        ...
        <div class="row profile">
                ...
                <div class="profile-sidebar">
                    ...
                    <div class="profile-usertitle">
                        <div class="profile-usertitle-name">
                            <span class="hidden-xs">Nome do perfil</span>
                        </div>
                        ...
                        <ul class="nav">
                            <li class="active">
                                <a href="#">
                                    ...
                                    <span class="hidden-xs">Informações pessoais<span> </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="glyphicon glyphicon-user"></i>
                                    <span class="hidden-xs">Endereço de entrega<span> </a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="glyphicon glyphicon-ok"></i>
                                    <span class="hidden-xs">Pedidos <span></a>
                            </li>
                            <li>
                                <a href="#">
                                    <i class="glyphicon glyphicon-shopping-cart"></i>
                                    <span class="hidden-xs">Carrinho<span> </a>
            ...
            <div class="col-md-9 order-content">
                ...
                <div class="form_main col-md-4 col-sm-5 col-xs-7">
                    <h4 class="heading"><strong>Contatos </strong> Pessoais <span></span></h4>
                    <div class="form">
