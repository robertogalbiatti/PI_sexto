    ...
    <?php include 'top.php'?>
        ...
        <div class="container-fluid">
          ...
          <form action="update_usuario_processa.php" method="post">
            ...
            <input type="text" class="form-control" name="id_usuarios" aria-describedby="emailHelp" placeholder="Entre com o id que deseja modificar">
            </div>

            <div class="form-group">
            <label for="exampleInputEmail1">Senha</label>
            <input type="text" class="form-control" name="senha" aria-describedby="emailHelp" placeholder="Entre com a nova senha">
            </div>

            <div class="form-group">
            <label for="exampleInputEmail1">Nome</label>
            <input type="text" class="form-control" name="nome" aria-describedby="emailHelp" placeholder="Entre com o novo nome">
            </div>
            ...
            <input type="text" class="form-control" name="cpf" aria-describedby="emailHelp" placeholder="Entre com o novo CPF">
            </div>
            ...
            <input type="text" class="form-control" name="celular" aria-describedby="emailHelp" placeholder="Entre com o novo celular: padrão '(99)999999999'">
            </div>

            <div class="form-group">
            <label for="exampleInputEmail1">Data de Nascimento</label>
            <input type="text" class="form-control" name="nascimento" aria-describedby="emailHelp" placeholder="Entre com a nova data: padrão 'AAAA-MM-DD'">
            </div>
